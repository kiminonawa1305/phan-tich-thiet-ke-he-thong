        ...
        <div class="row ">
            ...
            <div class="col-md-3 col-sm-3 col-4 py-3 px-0 d-flex align-items-center justify-content-end">
                <ul class="d-flex m-0 list-unstyled justify-content-end">
                    <li class="px-3 pt-1"><a class="nav-link active" aria-current="page" href="#"><i class="fa fa-phone"
                                    ...
                                    <li class="nav-item hv d-lg-none ">
                                        <ul class="navbar-nav justify-content-end ">
                                            <%
                                                if (obj == null) {
                                            %>
                                            <li class="nav-item dropdown hv d-flex justify-content-center align-items-center">
                                            ...
                                            <li class="nav-item dropdown hv d-flex justify-content-center align-items-center">
                                                <a class="nav-link dropdown-toggle" href="#" role="button"
                                                   data-bs-toggle="dropdown" aria-expanded="false">Tài khoản </a>
                                                <ul class="dropdown-menu" aria-labelledby="">
                                                    <li class="dropdown-item"> Xin chào: <span class="fw-bold "
                                                                                               class="name"><%=account.getName()%></span>
                                                    </li>
                                                    <li>
                                                        <hr class="dropdown-divider">
                                                    </li>
                                            ...
                                            <%} else {%>
                                            <li class="nav-item dropdown hv"><a class="nav-link dropdown-toggle"
                                                                                href="#" role="button"
                                ...
                                <ul class="navbar-nav justify-content-end">
                                    <li class="nav-item hv pe-2"><a class="nav-link" href="<%=url%>/Cart.jsp">
                                        <button class="position-relative border-0 bg-light "><i
                                                ...
                                                class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"><%=quantityItem%><span
                                    ...
                                    <%
                                        if (obj == null) {
                                    %>
                                    <li class="nav-item dropdown hv d-flex justify-content-center align-items-center"><a
