    ...
    <div class="container mt-3 pb-3">
        <div class="row py-3 float-xs-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <hr class="w-50">
                <ul class="navbar-nav">
                    <li class="px-3"><a class="nav-link link" href="#"><i class="fa fa-facebook-official"
                                                                          aria-hidden="true"></i> FaceBook</a></li>
                    <li class="px-3"><a class="nav-link link" href="#"><i class="fa fa-instagram"
                                                                          aria-hidden="true"></i> Instagram</a></li>
                    <li class="px-3"><a class="nav-link link" href="#"><i class="fa fa-twitter" aria-hidden="true"></i>Twitter</a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
