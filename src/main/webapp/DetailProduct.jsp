...
<div class="container-fluid mgt">
    ...
    <div class="container bgcolor mt-3">
        ...
        <div class="d-md-none d-sm-block d-block pt-2 ">
            ...
            <p class="price" name="price"><%=nF.format(product.getPrice())%>
            </p>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-9">
                    ...
                    <div class="col-lg-7 col-md-5">
                        <div class="row mt-3">
                            <div class="col-lg-12 d-md-block d-sm-none d-none">
                                <span class="nameProduct" name="nameProduct"><%=product.getName()%></span>
                                <p class="m-0 mb-4"><span class="t color-gray" name="amount-sold">300</span> <span
                                        class="t color-gray"> Đã bán</span></p>
                                <p class="price m-0 mb-4" name="price"><%=nF.format(product.getPrice())%>
                                </p>
                        ...
                        <div class="row">
                            <div class="col-lg-12 ">
                                ...
                                <span class="color-gray">Vận chuyển <i class="fa fa-truck" aria-hidden="true"></i> <span
                                        id="address">Thủ Đức</span> </span>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        ...
                        <p class="mb-2">- <%=product.getDescription()%>
                        </p>
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col-md-12">
                        ...
                        <p>- Vật liệu: <%=product.getMaterial()%>
                        </p>
                        <p>- Màu sắc: <%=product.getColor()%>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 d-lg-block d-md-none d-sm-none d-none pt-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><%=productSimilar.getName()%>
                        </h5>
                        <p class="card-text">
                        <p class="price"><%=nF.format(productSimilar.getPrice())%>
                        </p>
                        <%
                            int qty = 1;
                            if (cart != null) {
