...
<div class="container p-0 mgt">
    ...
    <div class="row p-2 mt-3 bgcolor">
        <div class="col-lg-4 col-sm-4 my-1">
            <h5 class="text-color text-start"><i class="fa fa-user-circle-o text-color" aria-hidden="true"></i> THÔNG
                TIN KHÁCH HÀNG</h5>
            <div class="mt-3">
        ...
        <div class="col-lg-6 col-sm-6 mt-1 ">
            <h5 class="text-color text-start"><i class="fa fa-map-marker text-color" aria-hidden="true"></i> ĐỊA CHỈ
                NHẬN HÀNG</h5>
            <span class="mt-3 d-block" id="address"><%=a.getAddressReceive()%></span>
        </div>
        <div class="col-lg-2 col-sm-2 mt-1 text-end">
            <button class="btnAdd bgcolor bd-full" id="editInFor" data-bs-toggle="modal" data-bs-target="#changeInfor">
                <i class="fa fa-pencil text-color " title="Chỉnh sửa thông tin liên hệ" aria-hidden="true"></i></button>
        </div>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <div class="text-danger text-center w-100" id="error"><%=res%>
                                        </div>
                                    </td>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <%
                                            if (a.getVerifyAccount().isStateVerify()) {%>
                                        <label class="w-100">Tài khoản đã xác thực <i
                                                class="fa fa-check-circle text-success" aria-hidden="true"></i></label>
                                        <%} else {%>
                                        <label class="w-100 ">Tài khoản của bạn chưa xác thực, <a href="reVerifyCode">xác
                                            thực ngay</a></label>
                                        <%}%>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="gender">
                                            <label class="ms-0" for="male">Nam</label><input class="ms-2 me-3"
                                                                                             type="radio" id="male"
                                                                                             name="gender"
                                                                                             value="Nam" <%= a.getGender().equals("Nam") ? "checked" : "" %> >
                                            <label for="female">Nữ</label> <input class="ms-2 me-3" type="radio"
                                                                                  id="female" name="gender"
                                                                                  value="Nữ" <%= a.getGender().equals("Nữ") ? "checked" : "" %>>
                                            <label for="other">Khác</label> <input class="ms-2 me-3" type="radio"
                                                                                   id="other" name="gender"
                                                                                   value="Khác" <%= a.getGender().equals("Khác") ? "checked" : "" %>>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr id="changeDCReceive">
                                    ...
                                    <td>
                                        <div id="">
                                            <input id="HienThiDCReice" name="DCNHHT" type="text"
                                                   value="<%=a.getAddressReceive()%>">
                                ...
                                <tr id="SubmitSB">
                                    <td colspan="2">
                                        <div>
                                            <button id="submit" name="SB" onclick="" style="color: white"> LƯU</button>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
        ...
        <div class="col-md-12 d-flex justify-content-center">
            <table class="my-4 tb">
                ...
                <tr class="tr">
                    ...
                    <td>
                        <%=p.formatSize(p.getLength())%>x<%=p.formatSize(p.getWidth())%>
                        x<%=p.formatSize(p.getHeight())%>
                    </td>
                    <td>
