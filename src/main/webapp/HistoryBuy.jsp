        ...
        <div class="col-lg-12 overflow-hidden">
            <table class="mb-3" id="wattingConfirm">
                ...
                <tr data-bs-toggle="modal" data-bs-target="#detailInvoice"
                    onclick="detailInvoice(<%=i.getIdInvoice()%>)">
                    <td class="w40">
                        <%=stt%>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="d-flex w-100 justify-content-center">
                            <button class="btnAdd bgcolor bd-full" data-bs-toggle="modal" data-bs-target="#"
                                    onclick="cancelInvoice(<%=i.getIdInvoice()%>)"><i class="fa fa-times text-color"
                                                                                      title="Huỷ đơn hàng"
            ...
            <table class="mb-3 d-none" id="confirmed">
                ...
                <tr data-bs-toggle="modal" data-bs-target="#detailInvoice"
                    ...
                    <td>
                        <div class="d-flex w-100 justify-content-center">
                            <button class="delete btnAdd bgcolor bd-full" data-bs-toggle="modal" data-bs-target="#"
                                    onclick="delInvoice('<%=i.getIdInvoice()%>', 'confirm')"><i
                                    class="fa fa-trash-o text-color" title="Xóa" aria-hidden="true"></i></button>
                        </div>
                    </td>
                </tr>
                <%
            ...
            <table class="mb-3 d-none" id="canceled">
                ...
                <tr data-bs-toggle="modal" data-bs-target="#detailInvoice"
                    ...
                    <td>
                        <div class="d-flex w-100 justify-content-center">
                            <button class="delete btnAdd bgcolor bd-full" data-bs-toggle="modal" data-bs-target="#"
                                    onclick="delInvoiceCancel('<%=i.getIdInvoice()%>', 'cancel')"><i
                                    class="fa fa-trash-o text-color" title="Xóa" aria-hidden="true"></i></button>
                        </div>
                    </td>
                </tr>
