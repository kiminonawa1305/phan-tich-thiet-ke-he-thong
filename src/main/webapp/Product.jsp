        ...
        <div class="col-lg-3">
            ...
            <div class=" d-none d-md-none d-lg-block mt-3 bg-light border border-1 ">
                ...
                <div class="ps-2">
                    ...
                    <div class="mb-2"><input type="radio" name="price" value="D500000" id="below500000"> <label
                            class="lbhv" for="below500000">Dưới 500.000 ₫</label></div>
                    <div class="mb-2"><input type="radio" name="price" value="D1000000" id="below1000000"> <label
                            class="lbhv" for="below1000000">Dưới 1.000.000 ₫</label></div>
                    <div class="mb-2"><input type="radio" name="price" value="D5000000" id="below5000000"> <label
                            class="lbhv" for="below5000000">Dưới 5.000.000 ₫</label></div>
                    <div class="mb-2"><input type="radio" name="price" value="D10000000" id="below10000000"> <label
                            class="lbhv" for="below10000000">Dưới 10.000.000 ₫</label></div>
                    <div class="mb-2"><input type="radio" name="price" value="Tren10000000" id="above10000000"> <label
                            class="lbhv" for="above10000000">Trên 10.000.000 ₫</label></div>
                    <h6 class="my-2 fw-bold">Màu sản phẩm</h6>
                    <%
                        if (listColor != null && !listColor.isEmpty()) {
                            for (String color : listColor) {
                    %>
                    <div class="mb-2"><input type="radio" name="color" id="<%=color%>" value="<%=color%>"> <label
                            class="lbhv" for="<%=color%>"><%=color%>
                    </label></div>
                    <%
                            }
                        }
                    ...
                    <div class="mb-2"><input type="radio" name="material" id="wood" value="Gỗ"> <label class="lbhv"
                                                                                                       for="wood">Gỗ</label>
                    </div>
                    <div class="mb-2"><input type="radio" name="material" id="iron" value="Sắt"> <label class="lbhv"
                                                                                                        for="iron">Sắt</label>
                    </div>
                    <div class="mb-2"><input type="radio" name="material" id="steel" value="Thép"> <label class="lbhv"
                                                                                                          for="steel">Thép</label>
                    </div>
                    <div class="mb-2"><input type="radio" name="material" id="leather" value="Da"> <label class="lbhv"
                                                                                                          for="leather">Da</label>
                    </div>
                    <div class="mb-2"><input type="radio" name="material" id="fabric" value="Vải"> <label class="lbhv"
                                                                                                          for="fabric">Vải</label>
                    </div>
                    <div class="mb-2"><input type="radio" name="material" id="bamboo" value="Tre"> <label class="lbhv"
                                                                                                          for="bamboo">Tre</label>
                    </div>
                    <div class="mb-2"><input type="radio" name="material" id="plastic" value="Nhựa"> <label class="lbhv"
                                                                                                            for="plastic">Nhựa</label>
                    </div>
                </div>
            </div>
        </div>
